// Canvas demo: bireactive's runtime + signals + generators driving a non-SVG renderer.
...
import { attachRaf } from "@bireactive/web";
...
export class MdCanvasField extends HTMLElement {
  ...
  constructor() {
    ...
    caption.textContent = `${N} particles on Canvas — bireactive's Anim, signals, struct value types, and generators driving a non-SVG renderer.`;

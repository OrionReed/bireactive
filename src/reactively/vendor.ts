// vendor.ts — @reactively/core, verbatim from milomg/reactively
// (packages/core/src/core.ts). Kept unmodified as the perf/correctness
// baseline that `core.ts` (our explicit-stack + bitflag variant) is measured
// against. Do not edit; regenerate from upstream if bumping.
